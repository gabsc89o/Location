...
public class MainActivity extends AppCompatActivity {
    ...
    LocationListener escuchador = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            DBLocation adp = new DBLocation(MainActivity.this);
            adp.altaCoordenada(String.valueOf(location.getAltitude()),String.valueOf(location.getLongitude()),String.valueOf(location.getLatitude()));
            adp.close();
        }
